...
<body>
	...
	<style>
		...
		.container{width:100%;height:100%;position:fixed;top:0;left:0;background:rgba(73, 68, 57, 0.6);text-align:center;}
		.container .loginbox{width:780px;margin:200px auto;text-align:center;position:relative;height:100%;}
		.container h1{font-size:32px;margin-bottom:42px;color:#f9f9f9;text-shadow:3px 3px 1px #111;box-shadow:0 0 20em #999}
		.container .loginbox  .inpb{margin-top:12px;box-shadow:0 0 200em #ccc;}
		.container .loginbox input[type='text']{width:320px;height:42px;border:1px solid #e5e5e5;font-family:"微软雅黑";text-indent:1em;box-shadow:2px 2px 1px #111}
	...
	<div class="container">
		<div class="loginbox">
			...
			<div class="inpb"><input type="text" id="account" laceholder="请输入学号/邮箱/手机"/></div>
			<div class="inpb"><input type="text" id="password"  placeholder="请输入密码"/></div>
			<div class="inpb"><input type="button" onclick="tzLogin(this)" value="登&nbsp;&nbsp;陆"/></div>
